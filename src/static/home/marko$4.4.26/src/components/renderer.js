$_mod.def("/marko$4.4.26/src/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.4.26/src/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.4.26/src/components/ComponentsContext'/*'./ComponentsContext'*/);
