$_mod.def("/marko$4.4.26/src/components/Component", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.4.26/src/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var defaultCreateOut = require('/marko$4.4.26/src/runtime/createOut'/*'../runtime/createOut'*/);
var getComponentsContext = require('/marko$4.4.26/src/components/ComponentsContext'/*'./ComponentsContext'*/).___getComponentsContext;
var componentsUtil = require('/marko$4.4.26/src/components/util-browser'/*'./util'*/);
...
var RenderResult = require('/marko$4.4.26/src/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.4.26/src/components/update-manager'/*'./update-manager'*/);
var morphdom = require('/marko$4.4.26/src/morphdom/index'/*'../morphdom'*/);
var eventDelegation = require('/marko$4.4.26/src/components/event-delegation'/*'./event-delegation'*/);
