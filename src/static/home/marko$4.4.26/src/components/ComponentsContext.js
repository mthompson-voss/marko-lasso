$_mod.def("/marko$4.4.26/src/components/ComponentsContext", function(require, exports, module, __filename, __dirname) { 'use strict';
...
var beginComponent = require('/marko$4.4.26/src/components/beginComponent-browser'/*'./beginComponent'*/);
