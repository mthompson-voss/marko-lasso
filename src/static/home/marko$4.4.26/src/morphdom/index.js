$_mod.def("/marko$4.4.26/src/morphdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
var defaultDoc = typeof document == 'undefined' ? undefined : document;
var specialElHandlers = require('/marko$4.4.26/src/morphdom/specialElHandlers'/*'./specialElHandlers'*/);

var morphAttrs = require('/marko$4.4.26/src/runtime/vdom/VElement'/*'../runtime/vdom/VElement'*/).___morphAttrs;
